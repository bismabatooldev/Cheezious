...
import { prodA } from '../data/productA'
...
const ImBack = () => {
    return (
        ...
        <p className='pb-5 font-bold text-3xl'>Im Back!</p>

        <div className='flex flex-wrap border-b pb-10'>
        {prodA.map((x)=>{
          return (
            <Link key={x._id} to={`/prodA/${x._id}`}>
            <div className="w-52 p-2.5 bg-white rounded-3xl shadow-md border hover:border-yellow-300 transform hover:scale-105 transition-transform duration-300 ease-in-out">

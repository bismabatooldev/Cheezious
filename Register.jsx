...
<div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
  ...
  <button className="text-2xl text-white"><HiMiniXMark /></button>
    ...
    <div className="my-6">
      <h4 className="text-3xl text-[#333] font-extrabold">Register</h4>
    ...
    <form className="space-y-4">
      ...
      <div className="relative flex items-center">
        <input type="password" placeholder="Confirm Password" className="px-4 py-3 bg-white text-[#333] w-full text-sm border-2 outline-[#007bff] rounded-lg" />
        <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-4 cursor-pointer" viewBox="0 0 128 128">
          <path d="M64 104C22.127 104 1.367 67.496.504 65.943a4 4 0 0 1 0-3.887C1.367 60.504 22.127 24 64 24s62.633 36.504 63.496 38.057a4 4 0 0 1 0 3.887C126.633 67.496 105.873 104 64 104zM8.707 63.994C13.465 71.205 32.146 96 64 96c31.955 0 50.553-24.775 55.293-31.994C114.535 56.795 95.854 32 64 32 32.045 32 13.447 56.775 8.707 63.994zM64 88c-13.234 0-24-10.766-24-24s10.766-24 24-24 24 10.766 24 24-10.766 24-24 24zm0-40c-8.822 0-16 7.178-16 16s7.178 16 16 16 16-7.178 16-16-7.178-16-16-16z" data-original="#000000" />
        </svg>
      </div>
      <div className="flex">
        ...
        <label className="text-sm ml-4 text-[#333]">I have read and accept the <a href="javascript:void(0)" className="text-sm text-blue-600 font-semibold">Terms and Conditions</a></label>
      </div>
      <button type="button" className="px-6 py-3 !mt-12 w-full font-semibold bg-[#d40000] hover:bg-[#ffcb04] hover:text-black text-white rounded-full">Create
        Account</button>
    </form>
    <hr className="my-6" />
    <p className="text-sm text-center text-[#333]">Already have an account? <Link to="/login" className="text-sm text-[#ffcb04] font-semibold">Sign in</Link></p>
  </div>
</div>

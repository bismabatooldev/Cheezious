...
const ImBackDetail = ()=> {
  ...
  const {_id} = useParams();
  const getdata = prodA.find((x)=>x._id == _id);
    return (
        <Layout>
        <div className='pt-36'>
  ...
  <div className="p-6 lg:max-w-7xl max-w-2xl max-lg:mx-auto">
    <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-10">
      ...
      <div>
        <div className="flex flex-wrap items-start pt-10 -ml-2">
          <div className='flex'>
            <h2 className="text-3xl font-extrabold text-gray-800">{getdata.title}</h2>
        ...
        <div className="flex flex-wrap lg:gap-20 gap-20 lg:mt-60 mt-8">
